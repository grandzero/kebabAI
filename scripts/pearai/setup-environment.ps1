...
function Initialize-BaseFunctionality {
    ...
    Set-Location .\extensions\kebabai-submodule
...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\kebabai-ref' -> 'extensions\kebabai-submodule\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\kebabai-submodule'
$targetPath = Join-Path -Path $modulePath -ChildPath 'extensions\vscode'
$linkPath = Join-Path -Path $currentDir -ChildPath 'extensions\kebabai-ref'
