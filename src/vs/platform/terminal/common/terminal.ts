...
export const enum FlowControlConstants {
	 ...
	 * apkebab to stutter. In reality this balance is hard to accomplish though so heavy commands
...
export interface ITerminalProfile {
	...
	/**
	 * An additional unsafe path that must exist, for example a script that apkebabs in {@link args}.
	 */
