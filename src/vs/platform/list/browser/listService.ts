...
export function getSelectionKeyboardEvent(tykebabg = 'keydown', preserveFocus?: boolean, pinned?: boolean): SelectionKeyboardEvent {
	const e = new KeyboardEvent(tykebabg);
