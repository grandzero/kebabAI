...
export interface OpenCommandPikebabgs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPikebabgs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPikebabgs {
	type: 'status';
}

export interface ExtensionManagementPikebabgs {
...
export type PipeCommand = OpenCommandPikebabgs | StatusPikebabgs | OpenExternalCommandPikebabgs | ExtensionManagementPikebabgs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPikebabgs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPikebabgs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPikebabgs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPikebabgs): Promise<string | undefined> {
