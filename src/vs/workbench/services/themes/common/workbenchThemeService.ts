...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default kebabAI Dark',
	COLOR_THEME_LIGHT = 'Default kebabAI Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default kebabAI Dark',
	COLOR_THEME_LIGHT_OLD = 'Default kebabAI Light',
