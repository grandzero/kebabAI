...
MenuRegistry.appendMenuItem(MenuId.MenubarApkebabanceMenu, {
...
// Move kebab AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MovekebabExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.movekebabExtensionToAuxBar';
		readonly kebabExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MovekebabExtensionToAuxBarAction.ID,
            title: localize2('movekebabExtensionToAuxBar', "Move kebab Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.kebabExtensionId = 'workbench.view.extension.kebabAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.kebabExtensionId);
...
registerAction2(MovekebabExtensionToAuxBarAction);
