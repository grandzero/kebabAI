...
const openkebabAIChat: WatermarkEntry = { text: localize('watermark.openkebabAIChat', "Open Chat"), id: 'kebabai.focusContinueInput', when: ContextKeyExpr.has('kebabAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.kebabAIBigChat', "Big Chat"), id: 'kebabai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('kebabAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.kebabAIPrevChat', "Previous Chat"), id: 'kebabai.loadRecentChat', when: ContextKeyExpr.has('kebabAIExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('kebabAIExtensionLoaded', true); // Set a context key when the kebabAI extension is loaded
